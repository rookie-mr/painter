...
var bootPATH = "/personal-website/manage/assets/";
//console.log(__CreateJSPath("boot.js"));
mini_debugger = true;                                         
...
//miniui
document.write('<script src="' + bootPATH + 'lib/jQuery/jquery.min.js" type="text/javascript"></sc' + 'ript>');
document.write('<script src="' + bootPATH + 'lib/miniui/miniui.js" type="text/javascript" ></sc' + 'ript>');
document.write('<link href="' + bootPATH + 'fonts/font-awesome-4.7.0/css/font-awesome.min.css" rel="stylesheet" type="text/css" />');
...
//skin
if (skin && skin != "default") document.write('<link href="' + bootPATH + 'lib/miniui/themes/' + skin + '/skin.css" rel="stylesheet" type="text/css" />');

//mode
if (mode && mode != "default") document.write('<link href="' + bootPATH + 'lib/miniui/themes/default/' + mode + '-mode.css" rel="stylesheet" type="text/css" />');
